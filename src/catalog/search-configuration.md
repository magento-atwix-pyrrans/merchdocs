...
{:.bs-callout-info}
For Magento 2.4.6 and higher you can set up OpenSearch instead of Elasticsearch. You need to choose the value `OpenSearch` for **Search Engine** setting.
...
1. For **Search Engine**, accept the value `Elasticsearch 7`.
   ...
   See [here][3]{:target="_blank"} what version of the Elasticsearch is required for all Commerce installations.
